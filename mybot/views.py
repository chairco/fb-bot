...
def post_facebook_message(fbid, recevied_message, reg=False):
    ...
    if reg == True and str.isdigit(recevied_message):
        ...
        q.wrong_choices.insert(q.answer, r)
        data = [
            {
                "content_type": "text",
        ...
        for entry in incoming_message['entry']:
            for message in entry['messaging']:
                ...
                if 'message' in message:
                    ...
                    print('message')
                    try:
                        post_facebook_message(message['sender']['id'], message['message']['text'], reg=True)
                    except:
                        return HttpResponse()
